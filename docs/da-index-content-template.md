...
| note | Migration | Tools remain code-first. | The root landing page stays authored for lightweight messaging, while operator workflows live under `/tools`. Oak Ops is the canonical UI for the fifth element, and adaptive `release-flow` remains the runtime truth. [Tool Catalogue](/tools/index.html) [Oak Ops](/tools/ops/ops.html) [EDS Integrations](https://www.aem.live/docs/integrations) |
